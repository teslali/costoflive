...
public class LandingPage {
	...
	By search = By.cssSelector("input[name='city-search']");
	...
	By clickIst = By.cssSelector(".type-ahead-results-item small");
	...
	public void clickIst() {
		driver.findElement(clickIst).click();
	}
